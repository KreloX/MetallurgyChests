...
public class GuiPlatinumChest extends GuiContainer {
    private static final ResourceLocation CHEST_GUI_TEXTURE = new ResourceLocation(Tags.MOD_ID, "textures/gui/platinum_chest.png");
    private final IInventory chestInventory;

    public GuiPlatinumChest(IInventory playerInventory, IInventory chestInventory, EntityPlayer player) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        fontRenderer.drawString(chestInventory.getDisplayName().getUnformattedText(), 10, 9, ModMetals.PLATINUM.getStats().getColorHex());
    }
