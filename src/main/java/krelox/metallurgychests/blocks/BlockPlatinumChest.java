...
public class BlockPlatinumChest extends BlockContainer
{
	...
	{
		return new TileEntityPlatinumChest();
	}
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        if (stack.hasDisplayName())
        {
            ...
            if(tileentity instanceof TileEntityPlatinumChest)
			{
				((TileEntityPlatinumChest)tileentity).setCustomName(stack.getDisplayName());
			}	
        }
    }
	...
	{
		TileEntityPlatinumChest tileentity = (TileEntityPlatinumChest)worldIn.getTileEntity(pos);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			playerIn.openGui(MetallurgyChests.instance, Reference.GUI_PLATINUM_CHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
    ...
    public ILockableContainer getContainer(World worldIn, BlockPos pos, boolean allowBlocking)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityPlatinumChest)tileentity;
