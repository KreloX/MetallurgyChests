...
public class BlockBrassChest extends BlockContainer
{
	...
	{
		return new TileEntityBrassChest();
	}
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        if (stack.hasDisplayName())
        {
            ...
            if(tileentity instanceof TileEntityBrassChest)
			{
				((TileEntityBrassChest)tileentity).setCustomName(stack.getDisplayName());
			}	
        }
    }
	...
	{
		TileEntityBrassChest tileentity = (TileEntityBrassChest)worldIn.getTileEntity(pos);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			playerIn.openGui(MetallurgyChests.instance, Reference.GUI_BRASS_CHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
    ...
    public ILockableContainer getContainer(World worldIn, BlockPos pos, boolean allowBlocking)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityBrassChest)tileentity;
