...
public class BlockElectrumChest extends BlockContainer
{
	...
	{
		return new TileEntityElectrumChest();
	}
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        if (stack.hasDisplayName())
        {
            ...
            if(tileentity instanceof TileEntityElectrumChest)
			{
				((TileEntityElectrumChest)tileentity).setCustomName(stack.getDisplayName());
			}	
        }
    }
	...
	{
		TileEntityElectrumChest tileentity = (TileEntityElectrumChest)worldIn.getTileEntity(pos);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			playerIn.openGui(MetallurgyChests.instance, Reference.GUI_ELECTRUM_CHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
    ...
    public ILockableContainer getContainer(World worldIn, BlockPos pos, boolean allowBlocking)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityElectrumChest)tileentity;
